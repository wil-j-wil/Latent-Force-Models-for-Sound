%% Analysis Data
[Actual,fs] = audioread('oboeC4.wav'); % the audio data
[allMag, allFreq] = readSpearFile('oboeC4.txt'); % sinusoidal analysis data from Spear
hopSize     = fs / 100; % Spear exports data with 10ms frames
saveResults = 1;    % save the results to a mat file?
matNameMag  = 'resultsOboe_2.mat'; % name of the .mat file saved if saveResults = 1
...
% first we must select our modes of vibration, and format the data
 ...
 priorityInference = 0; % 1 = smaller noise assumption for modes with larger amplitude, so they get priority
...
if priorityInference == 1
    n_sigma2 = 0.0001 ./ maxOfMode % priority inference. WJW - Feb 2017
else
